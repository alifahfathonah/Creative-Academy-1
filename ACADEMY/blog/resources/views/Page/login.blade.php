                ...
                <div class="container card">
                    <div class="row ">
                            <div class="col-md-6 mt-5 col-sm-12">
                                <div class="card-body">
                                <h5 class="title-text mt-3">USER LOGIN</h5>
                                ...
                                <a href="" data-toggle="modal" data-target="#quickModal" class="nav-font">Quick Recover</a>
                                </div>
                        ...
                        <div class="col-md-6  text-center col-sm-12">
                            <img class="w-100" src="{{asset('images/student.png')}}">
                        </div>
