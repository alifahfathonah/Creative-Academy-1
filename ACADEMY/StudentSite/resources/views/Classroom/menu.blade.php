        ...
        <nav class="navbar top-navbar fixed-top navbar-expand-md navbar-dark">
            <div class="navbar-collapse">
                <ul class="navbar-nav mr-auto mt-md-0">
                    <li class="nav-item "> <a class="nav-link nav-toggler text-white hidden-md-up  waves-effect " href="javascript:void(0)"><i class="fas  fa-bars"></i></a></li>
                    ...
                    <li class="nav-item mt-3">{{Session::get('name')}}{{Cookie::get('name')}}</li>
                </ul>
        ...
        <div class="scroll-sidebar">
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li> <a class="sideNavItem" href="{{url('tutorials')}}" ><span> <i class="fa fa-book"></i></span><span class="hide-menu"> Tutorials</span></a></li>
                    ...
                    <li> <a class="sideNavItem" target="_blank" href="{{url('https://web.facebook.com/groups/TeamRabbilPremium')}}" ><span> <i class="fab fa-facebook"></i></span><span class="hide-menu"> Join Discussion</span></a></li>
